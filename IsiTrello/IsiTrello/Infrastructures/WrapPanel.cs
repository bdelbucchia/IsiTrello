...
namespace IsiTrello.Infrastructures
{
    public class WrapPanel : Layout<View>
    {
       ...
       /* public static readonly BindableProperty OrientationProperty =
        ...
        public static readonly BindableProperty OrientationProperty =
            BindableProperty.Create(nameof(Orientation), typeof(StackOrientation), typeof(WrapPanel), StackOrientation.Vertical,
            propertyChanged:(bindable, oldvalue, newvalue) => ((WrapPanel)bindable).OnSizeChanged());
        ...
        public static readonly BindableProperty SpacingProperty =
            BindableProperty.Create(nameof(Spacing), typeof(double), typeof(WrapPanel), 6.0,
                propertyChanged: (bindable, oldvalue, newvalue) => ((WrapPanel)bindable).OnSizeChanged());
        ...
        public static readonly BindableProperty ItemTemplateProperty =
            BindableProperty.Create(nameof(ItemTemplate), typeof(DataTemplate), typeof(WrapPanel), null,
                propertyChanged: (bindable, oldvalue, newvalue) => ((WrapPanel)bindable).OnSizeChanged());
        ...
        public static readonly BindableProperty ItemsSourceProperty =
            BindableProperty.Create(nameof(ItemsSource), typeof(IEnumerable), typeof(WrapPanel), null,
        ...
        {
            oldvalue = oldvalue as IEnumerable;
            newvalue = newvalue as IEnumerable;
            //if (!(oldvalue is IEnumerable && newvalue is IEnumerable))
              //  throw new Exception("Erreur de valeurs");
            if (oldvalue != null)
            {
